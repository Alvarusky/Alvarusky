  ...
  <body>
    ...
    <div class='container-fluid mt-5'>
      <h1 class='display-4 fw-bold text-center'>
        Welcome to Alvaro de Miguel's personal site.
      </h1>
    </div>

    <div class='container-fluid py-5 padded-content'>
      ...
      <p>Welcome to my page guys, my name is alvaro, and this is the site where i host all my fun proyects, and maybe some thoughts i might have. Books, music, rocket science - all examples of stuff that i'm interested in.
        ...
        <br>
        I was born in spain in 2003, and i am currently studying physics at the University of Seville (US).
      </p>
